...
class TestAPIEndpoints:
    ...
    def test_analytics_endpoint_success(self, mock_get_api_client, mock_subscriptions, mock_orders):
        ...
        # Make get_api_client return our mocked client
        # This is a bit complex because we're mocking an async context manager
        mock_get_api_client.return_value.__aenter__.return_value = mock_api_client
    ...
    @patch('app.main.get_api_client')
    def test_analytics_endpoint_no_subscriptions(self, mock_get_api_client):
    ...
    @patch('app.main.get_api_client')
    def test_analytics_endpoint_api_error(self, mock_get_api_client):
